...
const MOVE = "move"
const ITEM = "item"
const SWITCH = ["other", "switch"]
const RECHARGING = ["other", "recharging"]
const BIDING = ["other", "biding"]
const RAGE = ["move", "rage"]
const STRUGGLE = ["move", "struggle"]
const PURSUIT = ["move", "pursuit"]
const UPROAR = ["move", "uproar"]
const FOCUS_PUNCH = ["move", "focus-punch"]
const ME_FIRST = ["move", "me-first"]

const PROTECT_TARGETS = [8, 9, 10, 11]

const PURSUIT_CHECK = ["baton-pass", "teleport", "u-turn", "volt-switch", "parting-shot"]

const HP_TYPES = ["fighting", "flying", "poison", "ground", "rock", "bug", "ghost", "steel", "fire", "water", "grass", "electric", "psychic", "ice", "dragon", "dark"]

const GROUNDED_CHECK = ["bounce", "fly", "high-jump-kick", "jump-kick", "magnet-rise", "splash"]

const HEAL_BLOCK_CHECK = ["heal-order", "milk-drink", "moonlight", "morning-sun", "recover", "rest", "roost", "slack-off", "soft-boiled", "synthesis", "wish", "lunar-dance", "healing-wish"]

const METRONOME_CHECK = ["assist", "chatter", "copycat", "counter", "covet", "destiny-bond", "detect", "endure", "feint", "focus-punch", "follow-me", "helping-hand", "me-first", "mimic", "mirror-coat", "mirror-move", "protect", "sketch", "sleep-talk", "snatch", "struggle", "switcheroo", "thief", "trick"]

const ENCORE_CHECK = ["transform", "mimic", "sketch", "mirror-move", "sleep-talk", "encore", "struggle"]

const ASSIST_CHECK = ["chatter", "copycat", "counter", "covet", "destiny-bond", "detect", "endure", "feint", "focus-punch", "follow-me", "helping-hand", "me-first", "metronome", "mimic", "mirror-coat", "mirror-move", "protect", "sketch", "sleep-talk", "snatch", "struggle", "switcheroo", "thief", "trick"]

const MAGIC_COAT_CHECK = ["attract", "block", "captivate", "charm", "confuse-ray", "cotton-spore", "dark-void", "fake-tears", "feather-dance", "flash", "flatter", "gastro-acid", "glare", "grass-whistle", "growl", "hypnosis", "kinesis", "leech-seed", "leer", "lovely-kiss", "mean-look", "metal-sound", "poison-gas", "poison-powder", "sand-attack", "scary-face", "screech", "sing", "sleep-powder", "smokescreen", "spider-web", "spore", "string-shot", "stun-spore", "supersonic", "swagger", "sweet-kiss", "sweet-scent", "tail-whip", "thunder-wave", "tickle", "toxic", "will-o-wisp", "worry-seed", "yawn"]

const SNATCH_CHECK = ["acid-armor", "acupressure", "agility", "amnesia", "aromatherapy", "barrier", "belly-drum", "bulk-up", "calm-mind", "camouflage", "charge", "cosmic-power", "defender-order", "defender-curl", "double-team", "dragon-dance", "focus-energy", "growth", "harden", "heal-bell", "heal-order", "howl", "ingrain", "iron-defense", "light-screen", "meditate", "milk-drink", "minimize", "mist", "moonlight", "morning-sun", "nasty-plot", "psych-up", "recover", "reflect", "refresh", "rest", "rock-polish", "roost", "safeguard", "sharpen", "slack-off", "soft-boiled", "stockpile", "substitute", "swallow", "swords-dance", "synthesis", "tail-glow", "tailwind", "withdraw"]

const SOUNDPROOF_CHECK = ["bug-buzz", "chatter", "grass-whistle", "growl", "heal-bell", "hyper-voice", "metal-sound", "perish-song", "roar", "screech", "sing", "snore", "supersonic", "uproar"]

const FREEZE_CHECK = ["flame-wheel", "sacred-fire", "flare-blitz"]

const PUNCH_CHECK = ["bullet-punch", "comet-punch", "dizzy-punch", "drain-punch", "dynamic-punch", "fire-punch", "focus-punch", "hammer-arm", "ice-punch", "match-punch", "mega-punch", "meteor-mash", "shadow-punch", "sky-uppercut", "thunder-punch"]

const RECOIL_CHECK = ["brave-bird", "double-edge", "flare-blitz", "head-smash", "high-jump-kick", "jump-kick", "submission", "take-down", "volt-tackle", "wood-hammer"]
...
const TWO_TURN_CHECK = ["razor-wind", "fly", "dig", "skull-bash", "sky-attack", "dive", "bounce", "shadow-force", "bide", "solar-beam", "ice-ball", "thrash", "petal-dance", "outrage"]
